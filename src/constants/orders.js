export const ADD_ORDERS_LIST_REQUEST = 'ADD_ORDERS_LIST_REQUEST';
...
export const SET_ORDERS_LIST_TOTAL = 'SET_ORDERS_LIST_TOTAL';
export const SET_ORDERS_LIST_CURRENT_PAGE = 'SET_ORDERS_LIST_CURRENT_PAGE';
export const LOAD_ORDERS_SUCCESS = 'LOAD_ORDERS_SUCCESS';
export const LOAD_ORDERS_FAILURE = 'LOAD_ORDERS_FAILURE';
export const GET_ORDER_DETAILS_SUCCESS = 'GET_ORDER_DETAILS_SUCCESS';
export const SET_ORDER_DETAILS_CURRENT_PAGE = 'SET_ORDER_DETAILS_CURRENT_PAGE';
...
export const SET_ORDER_ITEMS_LIST_TOTAL = 'SET_ORDER_ITEMS_LIST_TOTAL';
