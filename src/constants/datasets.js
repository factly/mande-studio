...
export const GET_DATASET_FAILURE = 'GET_DATASET_FAILURE';
export const DELETE_DATASET_FORMAT_SUCCESS = 'DELETE_DATASET_FORMAT_SUCCESS';
export const DELETE_DATASET_FORMAT_FAILURE = 'DELETE_DATASET_FORMAT_FAILURE';
export const CREATE_DATASET_FORMAT_SUCCESS = 'CREATE_DATASET_FORMAT_SUCCESS';
export const CREATE_DATASET_FORMAT_FAILURE = 'CREATE_DATASET_FORMAT_FAILURE';
export const DELETING_DATASET_FORMAT = 'DELETING_DATASET_FORMAT';
